...
const getAllMATHANG = async (req, res) => {
  try {
    const sqlQuery =
      "select mh.MaMH as MaMH, lh.TenLH as TenLH, nh.TenNH as TenNH, mh.MaGiamGia as MaGiamGia, mh.TenMH as TenMH,mh.GiamGia as GiamGia, mh.MoTa as MoTa, mh.DVT as DVT from sanpham mh inner join danhmuc lh on mh.MaLH = lh.MaLH inner join nhanhang nh on mh.MaNH = nh.MaNH";
...
const createMATHANG = async (req, res) => {
  ...
  const insertQuery = `INSERT INTO sanpham VALUES ('${reqMaMH}','${reqMaLH}','${reqMaGiamGia}',N'${reqTenMH}','${reqGiamGia}','${reqMoTa}','${reqDVT}','${reqMaNH}')`;
...
const updateMATHANG = async (req, res) => {
  ...
  const updateQuery = `UPDATE sanpham SET MaLH = '${reqMaLH}', MaNH = '${reqMaNH}', MaGiamGia = '${reqMaGiamGia}',TenMH = N'${reqTenMH}',GiamGia = '${reqGiamGia}',MoTa = N'${reqMoTa}',DVT = '${reqDVT}' WHERE MAMH = '${reqMaMH}'`;
  const checkMATHANG = `SELECT cOUNT(*) as count FROM sanpham WHERE MAMH = '${reqMaMH}'`;
