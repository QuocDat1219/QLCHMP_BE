...
const createNhanVien = async (req, res) => {
  ...
  const insertQuery = `INSERT INTO nhanvien VALUES ('${reqMaNV}','${reqMaCN}',N'${reqTenNV}', '${reqNgaySinh}','${reqGioiTinh}',N'${reqDiachi}','${reqSdt}')`;
...
const updateNhanVien = async (req, res) => {
  ...
  const updateQuery = `UPDATE nhanvien set MACN='${reqMaCN}', TENNV=N'${reqTenNV}', NGAYSINH = '${reqNgaySinh}', GIOITINH = '${reqGioiTinh}', DIACHI = N'${reqDiachi}', SDT = '${reqSdt}' where MANV = '${reqMaNV}'`;
  const checkNhanVien = `SELECT cOUNT(*) as count FROM NHANVIEN WHERE MaNV = '${reqMaNV}'`;
